...
int	CTFWeaponBase::InternalDrawModel( int flags, const RenderableInstance_t &instance )
{
	...
	bool bNotViewModel = ( (pOwner && !pOwner->IsLocalPlayer()) || C_BasePlayer::GetLocalPlayer()->ShouldDrawLocalPlayer() );
...
void CTFWeaponBase::ProcessMuzzleFlashEvent( void )
{
	...
	bool bDrawMuzzleFlashOnViewModel = ( pOwner->IsLocalPlayer() && !C_BasePlayer::GetLocalPlayer()->ShouldDrawLocalPlayer() ) ||
