...
bool CTFBotSniperLurk::FindHint( CTFBot *me )
{
	...
	else
	{
		...
		CollectPlayers( &victimVector, ( me->GetTeamNumber() == TF_TEAM_BLUE ? TF_TEAM_RED : TF_TEAM_BLUE ), COLLECT_ONLY_LIVING_PLAYERS );
...
bool CTFBotSniperLurk::FindNewHome( CTFBot *me )
{
	...
	TheTFNavMesh()->CollectSpawnRoomThresholdAreas( &enemySpawnThresholdVector, ( me->GetTeamNumber() == TF_TEAM_BLUE ? TF_TEAM_RED : TF_TEAM_BLUE ) );
