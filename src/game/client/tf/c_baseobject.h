...
public:
	...
	virtual C_BaseObject *GetBuildPointObject( int iPoint );
	...
	C_BaseObject			*GetParentObject( void );
...
public:
	...
	virtual void		SetObjectOnBuildPoint( int iPoint, C_BaseObject *pObject );
	...
	virtual C_BaseObject *GetObjectOfTypeOnMe( int iObjectType );
	virtual void		RemoveAllObjects( void );
	virtual int			FindObjectOnBuildPoint( C_BaseObject *pObject );
