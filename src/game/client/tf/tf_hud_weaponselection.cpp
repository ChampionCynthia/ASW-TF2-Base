...
void CHudWeaponSelection::OpenSelection( void )
{
	...
	if( pClientMode )
		pClientMode->GetViewportAnimationController()->StartAnimationSequence("OpenWeaponSelectionMenu");
	m_iSelectedBoxPosition = 0;
	m_iSelectedSlot = -1;
}
...
void CHudWeaponSelection::HideSelection( void )
{
	...
	if( pClientMode )
		pClientMode->GetViewportAnimationController()->StartAnimationSequence("CloseWeaponSelectionMenu");
}
